 ...
 * @author yangning
 */
export var BoxLayout = /** @class */ (function (_super) {
    ...
    function BoxLayout() {
        ...
        _this.startMouseP = new Point();
        _this.startSize = new Point();
        ////
        ////面板信息缓存相关
        ////
        ////
        ...
        ////
        _this.panelDic = {};
        _this.dragAreaElement = new DragArea();
        _this.maskElement = new Mask();
    ...
    BoxLayout.prototype.getActiveTabGroup = function () {
        var activeTabGroup = TabPanelFocusManager.getActiveGroup(this);
    ...
    BoxLayout.prototype.getActivePanel = function () {
        var panel = TabPanelFocusManager.currentFocus;
    ...
    BoxLayout.prototype.addBoxElement = function (target, element, position) {
        ...
        var newBox = new BoxLayoutContainer();
        newBox.gap = this.gap;
        switch (position) {
            case "bottom":
    ...
    BoxLayout.prototype.addToArea = function (element) {
        if (element) {
            ...
            if (element instanceof BoxLayoutContainer) {
                ...
                element.render.addEventListener(TabGroupEvent.FOCUS_CHANGED, this.panelHandle, this);
                element.render.addEventListener(TabGroupEvent.PANEL_REMOVING, this.panelHandle, this);
                element.render.addEventListener(TabGroupEvent.PANEL_ADDED, this.panelHandle, this);
    ...
    BoxLayout.prototype.removeFromArae = function (element) {
        if (element) {
            if (element instanceof BoxLayoutContainer) {
                ...
                element.render.removeEventListener(TabGroupEvent.FOCUS_CHANGED, this.panelHandle, this);
                element.render.removeEventListener(TabGroupEvent.PANEL_REMOVING, this.panelHandle, this);
                element.render.removeEventListener(TabGroupEvent.PANEL_ADDED, this.panelHandle, this);
    ...
    BoxLayout.prototype.panelHandle = function (e) {
        switch (e.type) {
            case TabGroupEvent.FOCUS_CHANGED:
                this.dispatchEvent(new BoxLayoutEvent(BoxLayoutEvent.FOCUS_CHANGED, e.data));
                break;
            ...
            case TabGroupEvent.PANEL_REMOVED:
                ...
                if (panels.length === 0) {
                    ...
                    this.dispatchEvent(new BoxLayoutEvent(BoxLayoutEvent.FOCUS_CHANGED, null));
                }
                break;
            case TabGroupEvent.PANEL_ADDED:
                this.dispatchEvent(new BoxLayoutEvent(BoxLayoutEvent.PANEL_ADDED, e.data));
                break;
    ...
    BoxLayout.prototype.getOldSpace = function (panelId) {
        ...
        if (link) {
            ...
            if (element) {
                var newElement = new BoxLayoutElement();
    ...
    BoxLayout.prototype.getOneDragRenderWithMouseEvent = function (e) {
        ...
        var localP = MatrixUtil.globalToLocal(this._area, new Point(e.clientX, e.clientY));
    ...
    BoxLayout.prototype.applyLayoutConfig = function (config) {
        ...
        //删除丢失的panel
        needRemoveList.forEach(function (panel) {
...
export var BoxLayoutElement = /** @class */ (function () {
    function BoxLayoutElement() {
        ...
        this._render.addEventListener(TabGroupEvent.PANEL_ADDED, this.panelHandler, this);
    }
...
export var BoxLayoutContainer = /** @class */ (function (_super) {
    ...
    function BoxLayoutContainer() {
        ...
        _this._gap = 1;
        _this._separator = new Separator();
...
export var TabPanel = /** @class */ (function (_super) {
    ...
    function TabPanel() {
        ...
        TabPanelFocusManager.push(_this);
        return _this;
    }
    ...
    TabPanel.prototype._focusIn = function () {
        ...
        this.dispatchEvent(new TabPanelEvent(TabPanelEvent.FOCUSIN, this));
    };
    TabPanel.prototype._focusOut = function () {
        this.updateClassName();
        this.dispatchEvent(new TabPanelEvent(TabPanelEvent.FOCUSOUT, this));
    };
    ...
    TabPanel.prototype.refresh = function () {
        this.dispatchEvent(new TabPanelEvent(TabPanelEvent.REFRESH));
    };
...
export var DefaultPanelSerialize = /** @class */ (function () {
...
export var PlaceholderPanel = /** @class */ (function (_super) {
...
export var DocumentElement = /** @class */ (function (_super) {
    __extends(DocumentElement, _super);

    function DocumentElement() {
        var _this = _super.call(this) || this;
        _this._render = new DocumentGroup();
...
export var BoxLayoutEvent = /** @class */ (function (_super) {
...
export var DragEvent = /** @class */ (function (_super) {
...
export var DragInfo = /** @class */ (function () {
    function DragInfo() {
        /**拖拽的区域 */
 ...
 * 布局配置文件
 */
export var LayoutConfig = /** @class */ (function (_super) {
    __extends(LayoutConfig, _super);

    function LayoutConfig() {
        var _this = _super.call(this) || this;
        _this._titleRenderFactory = new DefaultTitleRenderFactory();
        _this._documentTitleRenderFactory = new DefaultTitleRenderFactory();
        _this._useTabMenu = true;
        _this._panelSerialize = new DefaultPanelSerialize();
        _this._documentPanelSerialize = new DefaultPanelSerialize();
        return _this;
    }
    ...
    Object.defineProperty(LayoutConfig.prototype, "useTabMenu", {
        ...
        set: function (v) {
            if (this._useTabMenu !== v) {
                this._useTabMenu = v;
                this.dispatchEvent(new BoxLayoutEvent(BoxLayoutEvent.CONFIG_CHANGED));
            }
        },
        enumerable: true,
        configurable: true
...
export var Point = /** @class */ (function () {
    function Point(x, y) {
        if (x === void 0) {
            x = 0;
        }
...
export var Rectangle = /** @class */ (function () {
...
/// <reference path="./EventDispatcher.ts" />
export var TabBarEvent = /** @class */ (function (_super) {
...
/// <reference path="./EventDispatcher.ts" />
export var TabGroupEvent = /** @class */ (function (_super) {
...
export var TabPanelEvent = /** @class */ (function (_super) {
...
export var DocumentGroup = /** @class */ (function (_super) {
    ...
    DocumentGroup.prototype.adjustDragInfo_tabGroup = function (e, info) {
        var p = MatrixUtil.globalToLocal(this.container, new Point(e.clientX, e.clientY));
        p.x -= this.bx;
        p.y -= this.by;
        ...
        var globalP = MatrixUtil.localToGlobal(this.container, new Point(this.bx, this.by));
        if (obj['left'] && obj['top']) {
            if (p.x < p.y)
                dir = 'left';
            else
...
export var DragArea = /** @class */ (function () {
    function DragArea() {
        this.minHeight = 0;
        this.minWidth = 0;
...
/**分割条 */
export var Separator = /** @class */ (function () {
    function Separator() {
        this.minHeight = 0;
        this.minWidth = 0;
        this._root = document.createElement('div');
...
/// <reference path="../../data/EventDispatcher.ts" />
export var TabBar = /** @class */ (function (_super) {
...
/// <reference path="../../data/EventDispatcher.ts" />
export var TabGroup = /** @class */ (function (_super) {
    ...
    TabGroup.prototype.removePanel = function (v) {
        ...
        if (!isNaN(targetIndex)) {
            if (this.dispatchEvent(new TabGroupEvent(TabGroupEvent.PANEL_REMOVING, {
                panel: v,
                tabGroup: this
            }))) {
                ...
                this.reDeployPanels();
                this.dispatchEvent(new TabGroupEvent(TabGroupEvent.PANEL_REMOVED, {
                    panel: v,
                    tabGroup: this
                }));
                //设置新的选中索引
    ...
    TabGroup.prototype.addPanel = function (v) {
        ...
        this.tabBar.panels = this.panels;
        this.reDeployPanels();
        this.dispatchEvent(new TabGroupEvent(TabGroupEvent.PANEL_ADDED, {
            panel: v,
            tabGroup: this
        }));
        //设置新的选中索引
    ...
    TabGroup.prototype.reDeployPanels = function () {
        ...
        this.currentPanles.forEach(function (panel) {
            ...
            panel.removeEventListener(TabPanelEvent.REFRESH, _this.panelEventHandler, _this);
            panel.removeEventListener(TabPanelEvent.FOCUSIN, _this.panelEventHandler, _this);
            panel.removeEventListener(TabPanelEvent.FOCUSOUT, _this.panelEventHandler, _this);
        });
        this.currentPanles = this.panels.concat();
        this.currentPanles.forEach(function (panel) {
            panel.render(_this.container);
            panel._visible = false;
            panel.addEventListener(TabPanelEvent.REFRESH, _this.panelEventHandler, _this);
            panel.addEventListener(TabPanelEvent.FOCUSIN, _this.panelEventHandler, _this);
            panel.addEventListener(TabPanelEvent.FOCUSOUT, _this.panelEventHandler, _this);
        });
    };
    ...
    TabGroup.prototype.panelEventHandler = function (e) {
        switch (e.type) {
            case TabPanelEvent.FOCUSIN:
                this.dispatchEvent(new TabGroupEvent(TabGroupEvent.FOCUS_CHANGED, e.data));
    ...
    TabGroup.prototype.adjustDragInfo_tabBox = function (e, info) {
        var globalP = MatrixUtil.localToGlobal(this.tabBar.root, new Point());
        var bounds = this.tabBar.getBounds();
        var globalRange = new Rectangle(globalP.x, globalP.y, bounds.width, bounds.height);
        if (globalRange.containsPoint(new Point(e.clientX, e.clientY))) {
            ...
            if (info.otherData["startElement"] === this.ownerElement) {
                ...
                var p = MatrixUtil.localToGlobal(targetItem.root, new Point());
    ...
    TabGroup.prototype.render = function (container) {
        ...
        this.tabBar.addEventListener(TabBarEvent.MENUSELECTED, this.tabBarEventHandle, this);
        ...
        this.ownerElement.ownerLayout.config.addEventListener(BoxLayoutEvent.CONFIG_CHANGED, this.configHandle, this);
    };
    TabGroup.prototype.removeFromParent = function () {
        if (this.container) {
            ...
            this.tabBar.removeEventListener(TabBarEvent.MENUSELECTED, this.tabBarEventHandle, this);
            ...
            this.ownerElement.ownerLayout.config.removeEventListener(BoxLayoutEvent.CONFIG_CHANGED, this.configHandle, this);
        }
    };
 ...
 * TabPanel焦点管理器
 */
export var TabPanelFocusManager = /** @class */ (function () {
...
export var DefaultTitleRender = /** @class */ (function () {
...
export var DefaultTitleRenderFactory = /** @class */ (function () {
...
/// <reference path="../../data/EventDispatcher.ts" />
//测试拖拽面板
export var TestDragPanel = /** @class */ (function (_super) {
    ...
    TestDragPanel.prototype.adjustDragInfo = function (e, info) {
        var p = MatrixUtil.globalToLocal(this._root, new Point(e.clientX, e.clientY));
        var margin = 50;
        var dir;
        var obj = {};
        obj['left'] = p.x < margin;
        ...
        obj['center'] = (!obj['left'] && !obj['right'] && !obj['bottom'] && !obj['top']);
        var globalP = MatrixUtil.localToGlobal(this.root, new Point());
        if (obj['center']) {
            dir = 'center';
        } else if (obj['left'] && obj['top']) {
            if (p.x < p.y)
...
/**测试TabPanel */
export var TestTabPanel = /** @class */ (function (_super) {
...
/**测试选项卡头部渲染器 */
export var HeaderRender = /** @class */ (function () {
...
export var MatrixUtil = /** @class */ (function () {
    function MatrixUtil() {
    }
    ...
    MatrixUtil.getMatrixToWindow = function (target) {
        ...
        while (target.parentElement) {
            if (target.parentElement.scrollTop !== 0 || target.parentElement.scrollLeft !== 0) {
                var appendMatrix = new Matrix(1, 0, 0, 1, -target.parentElement.scrollLeft, -target.parentElement.scrollTop);
    ...
    MatrixUtil.getMatrix = function (target) {
        ...
        //追加一个位移矩阵
        var translateMatrix = new Matrix(1, 0, 0, 1, target.offsetLeft, target.offsetTop);
...
export var NumberUtil = /** @class */ (function () {
    function NumberUtil() {
    }
...
export var PopupMenu = /** @class */ (function () {
    ...
    PopupMenu.prototype.popup = function (target, menus, callback) {
        ...
        if (menus && menus.length > 0) {
            ...
            var globalP = MatrixUtil.localToGlobal(target, new Point(target.offsetWidth / 2 / target.offsetHeight / 2));
            var offset = 10;
    ...
    PopupMenu.prototype.mouseEventHandle = function (e) {
        switch (e.type) {
            case 'mousedown':
                var p = MatrixUtil.globalToLocal(this.menuContainer, new Point(e.clientX, e.clientY));
